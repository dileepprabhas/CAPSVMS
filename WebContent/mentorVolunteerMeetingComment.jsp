...
int n =st.executeUpdate("insert into student_head_meeting_comment (comment,admin_id,student_head_meeting_id,time) values ('"+comment+"','"+admin_id+"','"+id+"',  '"+formatter.format(date)+"' )"); 
