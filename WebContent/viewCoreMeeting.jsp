    ...
    <div class="row">
        ...
        <div  class="col-md-10 col-lg-9 col-sm-9 col-xs-12" style="padding:3px 0px;">
	      	...
	      	<ul class="collapsible" data-collapsible="accordion" style="list-style:none; margin-left:auto; margin-right:auto;">
				...
				<%if(adminType.equals("Branch Meeting Reviewer") || adminType.equals("Branch Co-ordinator") || adminType.equals("Co-ordinator") ) {%>
								...
								<form name="fn<%=meetingRs.getString("sub_admin_minutes_meeting.id")%>" id="f<%=meetingRs.getString("sub_admin_minutes_meeting.id")%>" action="coreMeetingEdit.jsp" method="post">
									...
									<div class="col-lg-6">
									 ...
									 <div class="center"  style=" text-align:center; margin:20px auto;  z-index:10;">
										<a class="btn btn-primary" href="coreMeetingStatus.jsp?id=<%=meetingRs.getString("sub_admin_minutes_meeting.id") %>&status=Approved"  ><span class="fa fa-check-square-o" style="font-size:18px; padding:3px;"><span style="font-size:14px;"> Approve</span></span> </a> 
				    					<a class="btn btn-primary" href="coreMeetingStatus.jsp?id=<%=meetingRs.getString("sub_admin_minutes_meeting.id") %>&status=Rejected" ><span  style="font-size:18px; padding:3px;" class="glyphicon glyphicon-remove-circle"><span style="font-size:14px;"> Reject</span></span></a>
							...
							<div class="collapsible-body" style="background-color: #fff;">
								...
								<form name="fn<%=meetingRs.getString("sub_admin_minutes_meeting.id")%>" id="f<%=meetingRs.getString("sub_admin_minutes_meeting.id")%>" action="coreMeetingEdit.jsp" method="post">
									...
									<div class="col-lg-6">
									 ...
									 <span><p id="msg<%=i%>" style="color: red; font-size:17px; display: inline-block;" > </p></span>
									 <%if(meetingRs.getString("admin.id").equals(adminId)) {%>
									 <div class="center"  style=" text-align:center; margin:20px auto;  z-index:10;">
